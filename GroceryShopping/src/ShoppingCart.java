...
public class ShoppingCart {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Cosa vuoi acquistare? Ci sono: Mele, Banane, Pane, Latte, Uova, Formaggio, Pollo, Riso, Pasta e Pomodoro (Digita 'Complete' per terminare o 'Exit' per uscire)");
